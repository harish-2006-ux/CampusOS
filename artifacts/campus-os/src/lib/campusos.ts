...
export const campusModules: CampusModule[] = [
  { id: 'overview', label: 'Career Twin', description: 'Your AI career operating system.', href: '/', roles: ['student'], icon: 'sparkles' },
  ...
  { id: 'campus-intelligence', label: 'Campus Intelligence', description: 'Placement-cell command center for the whole campus.', href: '/campus-intelligence', roles: ['officer', 'recruiter'], icon: 'building-2' },
];